...
# Create a new folder "MaskReminder" on the disk where the data is stored
# and unzip the download dataset into "MaskReminder".
datasource_path="/data/MaskReminder/datasource"
output_path="/data/MaskReminder"
