...
dataset_path="/data/MaskReminder"
# Store the trained model
check_point_path="/data/MaskReminder/log"
...
--preprocess_method ${preprocess_method} --preprocess_strategy ${preprocess_strategy} --seq_len 128 \
